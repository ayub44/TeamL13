                            ...
                            <div class="col-xl-6 col-lg-7">
                                ...
                                <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a class="current" href="ViewCase.php">View Cases</a></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3 style="text-align:center;">Cases Available</h3>
                        <p style="text-align:center;">Below Are The Cases Available</p>
                    </div>
                </div>
            </div>
        </div>
...
<table id="myTable" class="sortable">
    ...
    <tr class="header">
                ...
                <th title="Sort Table by Date Posted">Date Posted</th>
                <th title="Grant the user access to the website">View Case</th> 
                <th title="Refuse to allow User to join Website.">Apply For Case</th> 
            </tr>
        </thead>
    <tbody>
        <?php
...
$results = $pdo->query("SELECT * FROM CasesTable", PDO::FETCH_ASSOC);
...
print("<td data-label='Date Posted:'>".$row['DateAdded']."</td>");

print("<td data-label='View Location:'><a href='https://www.google.com/maps/place/$row[Location]' target='_blank'><span class='yes' title='View Case on Google Maps'>View Location</span></a>
</td>");


print("<td data-label='Date'><a href='ApplyCaseFiles/ApplyCase.php? 
&CaseId=$row[CaseId]
...
&DateAdded=$row[DateAdded]'><span class='no' title='Apply for Case<'>Apply for Case</span></a>
</td>");  
print("</tr>");
};
}
