                            ...
                            <div class="col-xl-6 col-lg-7">
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        ...
                                        <li><a class="current" href="SignupRep.php">Signup</a></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        ...
                        <p style="text-align:center;">Fill in the form below to sign up as a Police Rep.</p>
                    </div>
                </div>
            </div>
        </div>
...
?>
<div>
      <a href="Signuppage.php"><button type="button" class="REPSIGNUP">Signup as a Solicitor</button></a>
      <button type="button" class="SOLISIGNUP">Signup as a Rep</button>
    </div>
    	<h4 class="formTitle">Fill in the form below to join us as a Police Representative</h4>
