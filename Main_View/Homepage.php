                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-6">
                        <div class="slider_text">
                            <h5 class="wow fadeInLeft">Welcome to RapidReps</h5>
                            <h3 class="wow fadeInLeft">We connect Solictors to Police Station Reps</h3>
                            <!-- <p class="wow fadeInLeft">Find your next case</p> -->
                            <div class="sldier_btn wow fadeInLeft">
                                <a href="Loginpage.php" class="boxed-btn3">Login</a>
                            </div>
                        </div>
                    </div>
                </div>
