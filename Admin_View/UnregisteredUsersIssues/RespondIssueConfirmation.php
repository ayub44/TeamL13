...
<head>
    ...
    <title>Respond To Issue Final Confirmation | RapidReps</title>
<style>
 ...
 <div class="wrapper-1">
    ...
    <?php
       ...
       // checling if connected to Main_dbutils
        ...
        $body = "Dear $ISFName$ISLName, Below is our reposnse regarding the issue that you have reported on $DateSubmitted\r\nOur Response: $Response";
      

if(mail($receiver, $subject, $body, $headers)){
    print "<h1>Successfully responded to Issue ID: $FormID</h1>\n";
 ...
 ?>
      <a href="../UnregisteredUsers.php"><button class="go-home">Respond to more issues</button></a>
