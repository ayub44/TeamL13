...
<div class=thankyoucontent>
 <div class="wrapper-1">
    ...
    $sql = "DELETE From `contact_form_table` WHERE `FormID`='$FormID'";
    $delete = $pdo->exec( $sql);

     if($delete){

        print "<h1>Dear Admin. You have successfully deleted $FormID &#128522;</h1>\n";

    }else{
        echo "<p>Sorry, failed to delete $FormID </p>";
    }
  

            
 ?>
      <a href="../UnregisteredUsers.php"><button class="go-home">Delete more issues</button></a>
