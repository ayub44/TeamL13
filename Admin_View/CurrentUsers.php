...
<meta charset="utf-8">
    ...
    <title>Current Users | RapidReps</title>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        ...
                        <p style="text-align:center;">Below Are The Current Users Of The Website.</p>
                    </div>
                </div>
            </div>
        </div>
...
<table id="myTable" class="sortable">
    <thead >
        <tr class="header">
            ...
            <th title="Sort Table by Date Joined">Date Joined</th>
            <th title="Remove User From The Site">Remove User</th>
        </tr>
        </thead>
    <tbody>
        <?php
...
$results = $pdo->query("SELECT * FROM usertable", PDO::FETCH_ASSOC);
foreach( $results as $row) {
print("<tr class='item'>");
("<td data-label='Date'>".$row['UserID']."</td>");
...
print("<td data-label='Date'>".$row['DateJoined']."</td>");


print("<td data-label='Date'><a href='CurrentUsersFiles/RemoveCurrentUser.php? 
&UserID=$row[UserID]
...
&role=$row[role]
&DateJoined=$row[DateJoined]'><span class='no' title='Remove User From The Site'>&#10007;</span></a>
</td>");
print("</tr>");
};
}
