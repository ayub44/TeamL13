 ...
 <div class="wrapper-1">
    ...
    <?php
       ...
       // checling if connected to Main_dbutils
        ...
        $ISFName = $_GET['FirstName'];
        $ISLName = $_GET['LastName'];
        $ISPNumber = $_GET['phoneNumber'];
        $ISEmailAddress = $_GET['emailAddress'];
        $ISSummary = $_GET['issueSummary'];
        $ISDateReported = $_GET['dateReported'];
        $Response = $_GET['response'];

        $sender = "Ayubtesting101@gmail.com"; 
        ...
        $receiver = $ISEmailAddress;
        $subject = "Our Response about your Inquiry";
        $body = "Dear $ISFName$ISLName, Below is our reposnse regarding the issue that you have reported on $ISDateReported\r\nOur Response: $Response";
      

if(mail($receiver, $subject, $body, $headers)){
    print "<h1>Successfully responded to Issue ID: $issueID</h1>\n";
    
}else{
    echo "<h1>Sorry, Failed to respond</h1>";
} 
 ...
 ?>
      <a href="../RegisteredUsers.php"><button class="go-home">Respond to more issues</button></a>
