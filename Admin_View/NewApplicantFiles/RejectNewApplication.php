...
<div class="signupForm">    
    <form action="RejectNewApplicationConfirmation.php" method="get" enctype="multipart/form-data">

    	<h4 class="formTitle">Please Read through user details before denying them permission to join the Website</h4>
        ...
        <div>
            ...
            1) Once you click confirm user, user would be denied access to the website.</p>
        </div>

        <input type="submit" class="submitButton btn-primary btn-block btn-lg" value="Reject User">              
    </form>			
    <div class="text-center small">Don't want to reject user <a href="../NewApplicants.php">Go Back</a></div>
</div>
