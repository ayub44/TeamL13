...
<meta charset="utf-8">
    ...
    <title>Aboutuspage | RapidReps</title>
                            ...
                            <div class="col-xl-6 col-lg-7">
                                ...
                                <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a class="current"  href="Aboutuspage.php">About Us</a></li>
                                            <li><a href="#">Cases<i class="fa fa-angle-down"> </i> </a>
                                                <ul class="submenu">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        ...
                        <p style="text-align:center;">Some info about who we are and what we do.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    <div class="single_candidates text-center">
                        ...
                        <div class="thumb">
                            <img src="CSSFILES/img/Team/CEO.png" alt="">
                        </div>
                        <h5>Abdi Ali</h5>
                        <p>CEO & Founder</p>
                    </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="single_candidates text-center">
                        <div class="thumb">
                            <img src="CSSFILES/img/Team/Admin.png" alt="">
                        </div>
                        <h5>Thomas Terry</h5>
                        <p>Admin</p>
                    </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="single_candidates text-center">
                        <div class="thumb">
                            <img src="CSSFILES/img/Team/Designer.png" alt="">
                        </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="single_candidates text-center">
                        <div class="thumb">
                            <img src="CSSFILES/img/Team/Developer.png" alt="">
                        </div>
                        <h5>Wyne Mikel</h5>
                        <p>Developer</p>
                    </div>
